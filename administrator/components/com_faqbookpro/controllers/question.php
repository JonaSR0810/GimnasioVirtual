...
class FAQBookProControllerQuestion extends JControllerForm
{
	...
	protected function allowAdd($data = array())
	{
		...
		$topicId = JArrayHelper::getValue($data, 'topicid', $this->input->getInt('filter_topic_id'), 'int');
		$allow = null;
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_faqbookpro&view=questions' . $this->getRedirectToListAppend(), false));
